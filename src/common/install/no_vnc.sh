...
# use older version of websockify to prevent hanging connections on offline containers, see https://github.com/fuchuansia/docker-headless-vnc-container/issues/50
